const datosMarcadores = {
    ...
    "Mis páginas web": [
        ...
        { nombre: "Web Calificaciones Escolares", descripcion: "Aplicación web estática (HTML, CSS y JavaScript, sin dependencias de construcción) que presenta un reporte escolar interactivo con tres vistas: un libro animado con los indicadores de pre-primaria, la tabla de calificaciones de primaria y el resumen de asignaturas de secundaria.", url: "https://jeironpro.github.io/web-calificaciones-escolares/" },
    ],
    "Documentación": [
